...
namespace game {
	...
	world::registry_t& world::get_registry() {
		return registry;
	}

	world::registry_t const& world::get_registry() const {
		return registry;
	}

	std::shared_ptr<database::connection> world::get_database() {
		return database;
	}

	world::dispatcher_t& world::get_dispatcher() {
		return dispatcher;
	}

	world::map_t& world::get_map() {
		return map;
	}

	world::map_t const& world::get_map() const {
		return map;
	}
