...
#define INFOF(origin, format, ...) common::log::info(origin, format, __VA_ARGS__);
#define ERRF(origin, format, ...) common::log::error(origin, format, __VA_ARGS__);
#define WARNF(origin, format, ...) common::log::warn(origin, format, __VA_ARGS__);
#define DEBUGF(origin, format, ...) common::log::debug(origin, format, __VA_ARGS__);
#define TRACEF(origin, format, ...) common::log::trace(origin, format, __VA_ARGS__);
